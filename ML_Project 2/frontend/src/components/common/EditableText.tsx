/**
 * EditableText component - Enables inline AI editing of text segments.
 *
 * Features:
 * - Text selection detection
 * - Floating "Edit with AI" button
 * - Instruction prompt modal
 * - Calls /api/edit_text_segment
 * - Updates text in place
 */
...
interface EditableTextProps {
  ...
  context: string; // e.g., "Narration on page 2 of story 'Elephant's Brushstrokes'"
  className?: string;
}
